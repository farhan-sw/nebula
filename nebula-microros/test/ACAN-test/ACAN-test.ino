...
static const uint32_t DESIRED_BIT_RATE = 500UL * 1000UL ; // 1 Mb/s
...
//--- Start serial
  Serial.begin (115200) ;
  // Serial.begin (115200, SERIAL_8N1, GPIO_NUM_16, GPIO_NUM_17); // Set RX2 to GPIO 16 and TX2 to GPIO 17
  delay (100) ;
...
void loop () {
  ...
  while (ACAN_ESP32::can.receive (frame)) {
    ...
    Serial.print ("Extended: "); Serial.println (frame.ext);
    Serial.print ("RTR: "); Serial.println (frame.rtr);
    Serial.print ("Index: "); Serial.println (frame.idx);
    Serial.print ("Length: "); Serial.println (frame.len);
