...
void setup() {
  ...
  // Define QoS profiles
  rclc_qos_profile_t qos_profile = rclc_qos_profile_default();
  qos_profile.history = RCL_QOS_POLICY_HISTORY_KEEP_LAST;
  qos_profile.depth = 10;  // Adjust depth as needed
  qos_profile.reliability = RCL_QOS_POLICY_RELIABILITY_RELIABLE;
  qos_profile.durability = RCL_QOS_POLICY_DURABILITY_VOLATILE;
